    ...
    <table class="f6 w-100 mw9 center" cellspacing="0">
      <thead>
        <tr class="stripe-dark">
          <th class="fw6 tl pa2 bg-black-10">@lang('enquiry.FULLNAME')</th>
          <th class="fw6 tl pa2 bg-black-10">@lang('enquiry.MOBILE')</th>
          <th class="fw6 tl pa2 bg-black-10">@lang('enquiry.CONTACT_NUMBERS')</th>
          <th class="fw6 tl pa2 bg-black-10">@lang('enquiry.CASH_IN_HAND')</th>
          <th class="fw6 tl pa2 bg-black-10">@lang('enquiry.NEED_HOMELOAN')</th>
      ...
      <tbody class="lh-copy">
        ...
        <tr class="hover-bg-light-gray">
          ...
          <td class="pa2 bb b--black-10">{{ $enquiryObj->contact_numbers ?? '-' }}</td>
