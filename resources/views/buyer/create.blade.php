...
<div class="center">
  <article class="center mw5 mw7-ns br3 hidden ba b--black-10 mv4 shadow-1">
    <h1 class="f4 bg-navy o-50 br3 br--top white mv0 pv2 ph3">@lang('forms.REG_BUYER.HEADING')</h1>
    <div class="pa3 bt b--black-10 bg-white">
      <form method="POST" action="{{ route('buyer.store') }}" accept-charset="utf-8" autocomplete="off">
        @csrf

        <div class="mw9">
          <div class="cf ph2-ns">
            <div class="fl w-100 w-25-ns pa2-ns">
              <label class="fw4 lh-copy f6" for="permanent_address">@lang('forms.REG_BUYER.PERMANENT_ADDRESS')</label>
            </div>
        ...
        <div class="mw9 mt3 mt1-ns">
          <div class="cf ph2-ns">
            <div class="fl w-100 w-25-ns pa2-ns">
              <label class="fw4 lh-copy f6" for="present_address">@lang('forms.REG_BUYER.PRESENT_ADDRESS')</label>
            </div>
            <div class="fl w-100 w-75-ns pa2-ns">
        ...
        <div class="mw9 mt3 mt1-ns">
          <div class="cf ph2-ns">
            <div class="fl w-100 w-25-ns pa2-ns">
              <label class="fw4 lh-copy f6" for="contact_landline">@lang('forms.REG_BUYER.CONTACT_LANDLINE')</label>
            </div>
            <div class="fl w-100 w-75-ns pa2-ns">
        ...
        <div class="mw9 mt3 mt1-ns">
          <div class="cf ph2-ns">
            <div class="fl w-100 w-25-ns pa2-ns">
              <label class="fw4 lh-copy f6" for="alternate_email">@lang('forms.REG_BUYER.ALTERNATE_E-MAIL')</label>
            </div>
            <div class="fl w-100 w-75-ns pa2-ns">
