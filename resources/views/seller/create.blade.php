      ...
      <form method="POST" action="{{ route('register') }}" accept-charset="utf-8" autocomplete="off">
        ...
        <div class="mw9">
          <div class="cf ph2-ns">
            ...
            <div class="fl w-100 w-75-ns pa2-ns">
              <textarea class="pa2 input-reset ba b--black-10 bg-transparent w-90 w-80-ns measure" name="permanent_address" id="permanent_address" rows="3" cols="50">{{ old('permanent_address') }}</textarea>
        ...
        <div class="mw9 mt3 mt1-ns">
          <div class="cf ph2-ns">
            ...
            <div class="fl w-100 w-75-ns pa2-ns">
              <textarea class="pa2 input-reset ba b--black-10 bg-transparent w-90 w-80-ns measure" name="present_address" id="present_address" rows="3" cols="50" required autofocus>{{ old('present_address') }}</textarea>
        ...
        <div class="mw9 mt3 mt1-ns">
          <div class="cf ph2-ns">
            ...
            <div class="fl w-100 w-75-ns pa2-ns">
              <input class="pa2 input-reset ba b--black-10 bg-transparent w-90 w-80-ns measure" type="email" name="alternate_email" id="alternate_email" value="{{ old('alternate_email') }}" min="3" max="100" required>
